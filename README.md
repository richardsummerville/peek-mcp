...
| `capture_window`  | `window_id: int` *or* `app_name: string`      | inline PNG image |
| `capture_display` | `display_id?: int`                            | inline PNG image |
| `capture_region`  | `x, y, width, height: int`, `display_id?`     | inline PNG image |
